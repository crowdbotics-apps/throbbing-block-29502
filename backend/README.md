...
## Project Structure
    ...
    ├── throbbing_block_29502  # Django project configurations
...
1. Clone this repo and `cd throbbing_block_29502`
...
2. Clone this repo and `cd throbbing_block_29502`
